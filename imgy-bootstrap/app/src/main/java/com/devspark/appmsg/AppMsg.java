...
public class AppMsg {
	...
	/**
	 * Make a {@link com.devspark.appmsg.AppMsg} that just contains a text view.
	 * 
	 * @param context
	 *            The context to use. Usually your
	 *            {@link android.app.Activity} object.
	...
	/**
	 * Make a {@link com.devspark.appmsg.AppMsg} that just contains a text view with the text from a
	 * resource.
	 * 
	 * @param context
	 *            The context to use. Usually your
    ...
    /**
     * @return <code>true</code> if the {@link com.devspark.appmsg.AppMsg} is being displayed, else <code>false</code>.
     */
    boolean isShowing() {
    ...
    /**
	 * Cancels all queued {@link com.devspark.appmsg.AppMsg}s. If there is a {@link com.devspark.appmsg.AppMsg}
	...
	/**
	 * The style for a {@link com.devspark.appmsg.AppMsg}.
	 * @author e.shishkin
	 */
    public static class Style {
		...
		/**
		 * Construct an {@link com.devspark.appmsg.AppMsg.Style} object.
		 * 
		 * @param duration
